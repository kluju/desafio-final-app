                ...
                <Row>
                    <Col>
                        <Card>
                            ...
                            <CardFooter>
                                <Button className="btn btn-success float-right" onClick={handlerBack}><FaArrowLeft /> Volver</Button>
                                <ModalUserUpdate  updateAction={updateAction}  user={data} buttonLabel="actualizar" /> 
                            </CardFooter>
                        </Card>
                    </Col>
                </Row>
